...
//    _labelTitle = [[UILabel alloc]initWithFrame:CGRectMake(AlertPadding, AlertPadding, AlertWidth-2*AlertPadding, labelHeigh)];
    CGFloat labelHeigh = 50;
    _labelTitle = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, AlertWidth, labelHeigh)];
...
-(void)layoutSubviews{
    ...
    _contentScrollView.frame = CGRectMake(0, _labelTitle.frame.origin.y+_labelTitle.frame.size.height, _alertView.frame.size.width, _alertView.frame.size.height-MenuHeight-CGRectGetMaxY(_labelTitle.frame));
    self.contentView.frame = CGRectMake(0,0,self.contentView.frame.size.width, _contentScrollView.frame.size.height);
...
//    CGFloat height =  MIN([self screenBounds].size.height-MenuHeight,_alertView.frame.size.height+plus);
    ...
    _alertView.frame = CGRectMake(_alertView.frame.origin.x, _alertView.frame.origin.y, AlertWidth, 380);
